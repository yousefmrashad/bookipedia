...
class DB:
    ...
    def create(self):
        self.client.collections.create(name=DB_NAME,
            ...
            properties = [
                ...
                wvc.config.Property(name="l1", data_type=wvc.config.DataType.INT, vectorize_property_name=False),
                wvc.config.Property(name="l2", data_type=wvc.config.DataType.INT, vectorize_property_name=False),
            ])
# -------------------------------------------------- #